...
const CatalogManage = () => {
  ...
  const handleSelectedDepartment = async (id) => {
    ...
    try{
      const response = await axios.get(`https://api.tuplrc-cla.com/api/data/topic/${id}`).then(res=>res.data)
      setTopics(response)
  ...
  const handleSaveDept = async () => {
        ...
        try {
            const response = await axios.post("https://api.tuplrc-cla.com/api/data/dept", {
                dept_name: deptName,
    ...
    const handleSaveTopic = async () => {
      ...
      try {
          const response = await axios.post("https://api.tuplrc-cla.com/api/data/topic", {
