...
const CirculationCheckout = () => {
  ...
  const getPatron = async () => {
    try {
      const response = await axios.get(`https://api.tuplrc-cla.com/api/patron/checkout`, {
        params: { id },
      });
    ...
    try {
      const checkinPromises = selectedItems.map(async (item) => {
        try {
          ...
          const response = await axios.post(`https://api.tuplrc-cla.com/api/circulation/checkin`, {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const checkoutPromises = selectedItems.map((item) => {
        return axios.post(`https://api.tuplrc-cla.com/api/circulation/checkout`, {
          checkout_date: date,
